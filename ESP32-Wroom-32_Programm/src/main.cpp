...
// --- Alle globalen Variablen und Testdaten von oben bleiben exakt gleich ---
...
float* test_samples[] = { sample_digit_2, sample_digit_6 };
const int correct_labels[] = { 2, 6 };
...
/**
 * ===================================================================
 * app_main() - Der Haupteinstiegspunkt für ESP-IDF
 * ===================================================================
 */
extern "C" void app_main(void)
{
    // Warte kurz, damit der Serial Monitor verbunden werden kann
